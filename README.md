...
- [ ] **Klinik / tedavi odası fotoğrafları** — Giriş slider'ındaki 2. ve 3.
      slayt hâlâ yer tutucu metin gösteriyor, gerçek fotoğraflarla
      değiştirilmeli (`index.html` içinde `slide-2` ve `slide-3` sınıflarını
      arayın).
